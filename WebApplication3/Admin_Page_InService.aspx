<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Page_InService.aspx.cs" Inherits="WebApplication3.Admin_Page_InService" %>
	...
	<div id="wrapper"/>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
                        ...
                        <li><a href="Admin_Page_Customers.aspx" class="active"><i class="lnr lnr-cart"></i> <span>Customers</span></a></li>
						<li>
		...
		<div class="main">
			...
			<div class="main-content">
                ...
                <asp:GridView ID="grid12" runat="server"></asp:GridView>
				<!-- <div class="container-fluid">
