<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateStock.aspx.cs" Inherits="WebApplication3.UpdateStock" %>
        ...
        <div class="container">
            <form method="POST" class="appointment-form" id="appointmentform" runat="server">
                ...
                <div class="form-group-1">
                    <input type="number" name="name" id="Number1id" placeholder="ID" required runat ="server"/>
                    ...
                    <asp:Button runat="server" class="submit" onclick="UpdateStockk"  Text ="Update Stock"/> 
