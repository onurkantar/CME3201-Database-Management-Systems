<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchAndDeleteStock.aspx.cs" Inherits="WebApplication3.SearchAndDeleteStock" %>
	...
	<div id="wrapper">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class=""><i class="lnr lnr-users"></i> <span>Employees</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									...
									<li><a href="SearchAndDeleteEmployee.aspx" class="active">Search & Delete Employee</a></li>
						...
						<li>
							<a href="#subPages2" data-toggle="collapse" class="active"><i class="lnr lnr-pie-chart"></i> <span>Stocks</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages2" class="collapse ">
								<ul class="nav">
									<li><a href="Admin_Page_Stocks.aspx" class="">See All Stocks</a></li>
									<li><a href="AddStock.aspx" class="">Add Stock</a></li>
									<li><a href="SearchAndDeleteStock.aspx" class="active">Search & Delete Stock</a></li>
		...
		<div class="main" runat="server">
			...
			<div class="main-content" runat="server">
						...
						<input id="idF" name="idF" type="text" class="form-control" placeholder="Please Enter The Stock ID..." runat="server"/>
						<asp:Button runat="server" OnClick="SearchStock" Text="Search Stock"/>
                        <asp:Button runat="server" OnClick="DeleteStock" Text="Delete Stock"/>
                        

                <asp:GridView ID="grid4" runat="server"></asp:GridView>
				<!-- <div class="container-fluid">
