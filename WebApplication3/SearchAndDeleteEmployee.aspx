	...
	<div id="wrapper">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages2" class="collapse ">
								<ul class="nav">
									<li><a href="Admin_Page_Employees.aspx" class="active">See All Stocks</a></li>
		...
		<div class="main" runat="server">
			...
			<div class="main-content" runat="server">
						...
						<input id="idField3" name="idField3" type="text" class="form-control" placeholder="Please Enter The Employee ID..." runat="server"/>
						<asp:Button runat="server" OnClick="SearchEmployee" Text="Search Employee"/>
                        <asp:Button runat="server" OnClick="DeleteEmployee" Text="Delete Employee"/>
